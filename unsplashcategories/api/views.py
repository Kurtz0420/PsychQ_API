...
from unsplashcategories.api.serializers import UnsplashCategorySerializer
from unsplashcategories.models import UnsplashCategory


class UnsplashCategoryApiView(
    ...
    def patch(self, request, *args, **kwargs):
        ...
        object_to_update = UnsplashCategory.objects.filter(id=pk).first()
        ...
        serializer = UnsplashCategorySerializer(object_to_update, data=request.data, partial=True)
    ...
    def get_object(self):
        ...
        return UnsplashCategory.objects.get(id=id_)
...
class UnsplashCategoryRudView(generics.RetrieveUpdateDestroyAPIView):
    ...
    def get_queryset(self):
        return UnsplashCategory.objects.all()
